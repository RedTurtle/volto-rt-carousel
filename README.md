...
Uses Swiper from ![https://swiperjs.com/](https://swiperjs.com/)

## Listing

You could configure new listing carousel template from config defining it in config:
...
config.settings['volto-rt-carousel'] = {
  slide_appearances: {
    appearance1: {
      name: 'Appearance 1',
      component: Appearance1Component,
    },
  },
};
```
